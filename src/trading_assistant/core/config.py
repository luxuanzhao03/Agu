...
class Settings(BaseSettings):
    ...
    small_capital_cash_buffer_ratio: float = Field(default=0.10)
    small_capital_min_expected_edge_bps: float = Field(default=80.0)
    ...
    tushare_disclosure_warning_score: float = Field(default=0.75)
    tushare_disclosure_critical_score: float = Field(default=0.90)
    tushare_forecast_warning_pct: float = Field(default=-35.0)
    tushare_forecast_critical_pct: float = Field(default=-60.0)
    small_cap_pledge_critical_ratio: float = Field(default=50.0)
    small_cap_unlock_warning_ratio: float = Field(default=0.20)
